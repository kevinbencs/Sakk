...
void Black_rook::step_down(Ui::Game* ui, const int &row, const int &column,int *datas)
{
    for(int i=row+1;i>=0 && i<8;i++){
        if(*(datas+i*8+column)==0){
            ui->tableWidget->item(i,column)->setBackground(Qt::green);
...
void Black_rook::step_left(Ui::Game* ui,const int &row, const int &column,int *datas)
{
...
void Black_rook::step_right(Ui::Game* ui, const int &row, const int &column,int *datas)
{
    for(int i=column+1;i>=0 && i<8; i++){
        if(*(datas+row*8+i)==0){
            ui->tableWidget->item(row,i)->setBackground(Qt::green);
...
void Black_rook::step(Ui::Game *ui, const int &row, const int &column, int &RowOld, int &ColumnOld, int &piece, int &BlackOrWhite, bool &BlackKingRookDidNotMoveRight, bool &BlackKingRookDidNotMoveLeft,int *datas)
{
    Check check;
...
void Black_rook::right_check_step(Ui::Game* ui, const int &row, const int &column,const int &AttackerColumn,int *datas)
{
    for(int i=column-1;i>=AttackerColumn;i--){
        if(i!=AttackerColumn){
            if(*(datas+row*8+i)!=0){
...
void Black_rook::up_check_step(Ui::Game* ui,const int &row, const int &column,const int &AttackerRow,int *datas)
{
...
void Black_rook::down_check_step(Ui::Game* ui,const int &row, const int &column,const int &AttackerRow,int *datas)
{
    for(int i=row+1;i<=AttackerRow;i++){
        if(i!=AttackerRow){
            if(*(datas+i*8+column)!=0){
...
void Black_rook::king_column_black_queen_rook_column_equal_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,int *datas)
{
    Check check;
...
void Black_rook::king_row_black_queen_rook_row_equal_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,int *datas)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_left_down_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column,int *datas)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_left_up_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column,int *datas)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_right_down_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column,int *datas)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_right_up_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column,int *datas)
{
    Check check;
...
void Black_rook::check_step(Ui::Game *ui, const int &row, const int &column, int &piece, int &OldRow, int &OldColumn, int &AttackerRow, int &AttackerColumn,int &BlackOrWhite,int &king_row, int &king_column, bool &BlackKingRookDidNotMoveRight, bool &BlackKingRookDidNotMoveLeft,int *datas)
{
    Check check;
...
void Black_rook::check_knight_and_bishop_step(Ui::Game *ui, const int &row, const int &column, int &piece, int &OldRow, int &OldColumn, int &AttackerRow, int &AttackerColumn,int &BlackOrWhite, bool &BlackKingRookDidNotMoveRight, bool &BlackKingRookDidNotMoveLeft,int *datas)
{
    Check check;
...
void Black_rook::right_check_step(int *datas, const int &row, const int &column,const int &AttackerColumn,bool &CanMove)
{
    for(int i=column-1;i>=AttackerColumn;i--){
        if(i!=AttackerColumn){
            if(*(datas+row*8+i)!=0){
...
void Black_rook::up_check_step(int *datas,const int &row, const int &column,const int &AttackerRow,bool &CanMove)
{
    for(int i=row-1;i>=AttackerRow;i--){
        if(i!=AttackerRow){
            if(*(datas+i*8+column)!=0){
...
void Black_rook::down_check_step(int *datas,const int &row, const int &column,const int &AttackerRow,bool &CanMove)
{
    for(int i=row+1;i<=AttackerRow;i++){
        if(i!=AttackerRow){
            if(*(datas+i*8+column)!=0){
...
void Black_rook::king_column_black_queen_rook_column_equal_step(int *datas,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,bool &CanMove, const int &king_row, const int &king_column)
{
    Check check;
...
void Black_rook::king_row_black_queen_rook_row_equal_step(int *datas,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,bool &CanMove, const int &king_row, const int &king_column)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_left_down_step(int *datas, const int &row, const int &column, const int &AttackerColumn, const int &AttackerRow, const int &king_row, const int &king_column,bool &CanMove)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_left_up_step(int *datas,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column,bool &CanMove)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_right_down_step(int *datas,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column,bool &CanMove)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_right_up_step(int *datas,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column,bool &CanMove)
{
    Check check;
...
bool Black_rook::get_checkmate_CanMove(int *datas, const int &AttackerRow, const int &AttackerColumn, const int &KnightBishop)
{
    Check check;
...
void Black_rook::step_up(int *datas, const int &row, const int &column,bool &CanMove)
{
    if(row-1>=0){
...
void Black_rook::step_down(int *datas, const int &row, const int &column,bool &CanMove)
{
    if(row+1<8){
        if(*(datas+(row+1)*8+column)==0){
            CanMove=true;
...
void Black_rook::step_left(int *datas, const int &row, const int &column,bool &CanMove)
{
    if(column-1>=0){
...
void Black_rook::step_right(int *datas, const int &row, const int &column,bool &CanMove)
{
    if(column+1<8){
        if(*(datas+row*8+column+1)==0){
            CanMove=true;
...
bool Black_rook::get_draw_CanMove(int *datas)
{
    Check check;
    int row, column;
    bool CanMove=false;
...
void Black_rook::step_machine(int *datas, const int &row, const int &column,std::vector<std::vector<int>> &MoveAndPoint)
{
    Check check;
...
void Black_rook::king_column_black_queen_rook_column_equal_step_machine(int *datas,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,std::vector<std::vector<int>> &MoveAndPoint, const int &king_row, const int &king_column)
{
    Check check;
...
void Black_rook::king_row_black_queen_rook_row_equal_step_machine(int *datas,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,std::vector<std::vector<int>> &MoveAndPoint, const int &king_row, const int &king_column)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_left_down_step_machine(int *datas, const int &row, const int &column, const int &AttackerColumn, const int &AttackerRow, const int &king_row, const int &king_column,std::vector<std::vector<int>> &MoveAndPoint)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_left_up_step_machine(int *datas,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column,std::vector<std::vector<int>> &MoveAndPoint)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_right_down_step_machine(int *datas,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column,std::vector<std::vector<int>> &MoveAndPoint)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_right_up_step_machine(int *datas,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column,std::vector<std::vector<int>> &MoveAndPoint)
{
    Check check;
...
void Black_rook::step_check_machine(int *datas, const int &AttackerRow, const int &AttackerColumn, const int &KnightBishop, std::vector<std::vector<int>> &MoveAndPoint,const int &row, const int &column)
{
    Check check;
