...
void Black_rook::step_up(Ui::Game* ui,const int &row, const int &column,int &piece)
{
...
void Black_rook::step_down(Ui::Game* ui, const int &row, const int &column, int &piece)
{
    for(int i=row+1;i>=0 && i<8;i++){
        if(ui->tableWidget->item(i,column)->text()==""){
            ui->tableWidget->item(i,column)->setBackground(Qt::green);
...
void Black_rook::step_left(Ui::Game* ui,const int &row, const int &column,int &piece)
{
...
void Black_rook::step_right(Ui::Game* ui, const int &row, const int &column, int &piece)
{
    for(int i=column+1;i>=0 && i<8; i++){
        if(ui->tableWidget->item(row,i)->text()==""){
            ui->tableWidget->item(row,i)->setBackground(Qt::green);
...
void Black_rook::step(Ui::Game *ui, const int &row, const int &column, int &RowOld, int &ColumnOld, int &piece, int &BlackOrWhite, bool &BlackKingRookDidNotMoveRight, bool &BlackKingRookDidNotMoveLeft)
{
    Check check;
...
void Black_rook::left_check_step(Ui::Game* ui, const int &row, const int &column,const int &AttackerColumn)
{
...
void Black_rook::right_check_step(Ui::Game* ui, const int &row, const int &column,const int &AttackerColumn)
{
    for(int i=column-1;i>=AttackerColumn;i--){
        if(i!=AttackerColumn){
            if(ui->tableWidget->item(row,i)->text()!=""){
...
void Black_rook::up_check_step(Ui::Game* ui,const int &row, const int &column,const int &AttackerRow)
{
...
void Black_rook::down_check_step(Ui::Game* ui,const int &row, const int &column,const int &AttackerRow)
{
    for(int i=row+1;i<=AttackerRow;i++){
        if(i!=AttackerRow){
            if(ui->tableWidget->item(i,column)->text()!=""){
...
void Black_rook::king_column_black_queen_rook_column_equal_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow)
{
    Check check;
...
void Black_rook::king_row_black_queen_rook_row_equal_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_left_down_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_left_up_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_right_down_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column)
{
    Check check;
...
void Black_rook::king_dialog_black_queen_pawn_equal_right_up_step(Ui::Game* ui,const int &row,const int &column,const int &AttackerColumn,const int &AttackerRow,const int &king_row,const int &king_column)
{
    Check check;
...
void Black_rook::check_step(Ui::Game *ui, const int &row, const int &column, int &piece, int &OldRow, int &OldColumn, int &AttackerRow, int &AttackerColumn,int &BlackOrWhite,int &king_row, int &king_column, bool &BlackKingRookDidNotMoveRight, bool &BlackKingRookDidNotMoveLeft)
{
    Check check;
...
void Black_rook::check_knight_and_bishop_step(Ui::Game *ui, const int &row, const int &column, int &piece, int &OldRow, int &OldColumn, int &AttackerRow, int &AttackerColumn,int &BlackOrWhite, bool &BlackKingRookDidNotMoveRight, bool &BlackKingRookDidNotMoveLeft)
{
    Check check;
